...
const jeopardyCategories = [
  {
    ...
    questions: [
      ...
      {
        question: "Which superhero uses the best harnessing gear?",
        answers: ["Aquaman", "Superman", "Batman"],
        correct: "Batman",
        level: "medium",
      },
      {
        question: "What level of protective vest can stop a 7.62 caliber bullet fired from close range?",
        answers: ["2A", "3A", "4B"],
        correct: "3A",
        level: "hard",
      },
    ...
    questions: [
      {
        ...
        answers: [
          "2 or more feet from the edge",
          "In piles right next to trench exit",
          "In trench or hole",
        ],
      ...
      {
        question:
          "Wheres the furthest distance you should ever be from an escape route while working in a trench?",
  ...
  },
  {
    ...
    questions: [
      {
        question:
          "If you are working more than this number of feet above the ground, OSHA requires you to be protected by a fall protection system of some kind.?",
      ...
      {
        question:
          "If stairs have ____ or more risers, they must have a handrail.",
        answers: ["4", "10", "12"],
        correct: "4",
        level: "medium",
      },
  ...
  },
  {
    ...
    questions: [
      {
        question:
          "What is the leading cause of most construction site fatalities?",
      ...
      {
        question:
          "What is the closest you can generally build a scaffold near a power line?",
  ...
  },
  {
    ...
    questions: [
      {
        question:
          "How many feet can you dig a trench before you need to install a protective system of some kind?",
        answers: ["3", "5", "10"],
        correct: "5",
        level: "easy",
      },
      ...
      {
        question:
          "Scaffolds must be designed to carry how many times the load to meet OSHA guidlines?",
        answers: ["x2", "x4", "x10"],
        correct: "x10",
        level: "hard",
      },
